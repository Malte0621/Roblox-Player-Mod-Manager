...
namespace RobloxPlayerModManager
{
    public partial class FlagEditor : Form
    {
        ...
        private async void InitializeEditor()
        {
            ...
            if (lastExecVersion != versionGuid || !File.Exists(settingsPath))
            {
                ...
                {
                    client.DownloadFile("https://clientsettingscdn.roblox.com/v1/settings/application?applicationName=PCDesktopClient", settingsPath);
                }
                ...
                {
                    // Run Roblox Player briefly so we can update the settings file.
                    ...
                    Process player = Process.Start(playerStartInfo);
                    ...
                    // Nuke player and flag the version we updated with.
        ...
        public static void ApplyFlags()
        {
            ...
            string playerDir = PlayerBootstrapper.GetPlayerDirectory();

            string clientSettings = Path.Combine(playerDir, "ClientSettings");
